              ...
              <ul className="am-list admin-sidebar-list">
                ...
                <li className="admin-parent">
                  ...
                  <ul className="am-list am-collapse admin-sidebar-sub am-in" id="collapse-nav">
                    <li><a href="#cstm/submitted"><span className="am-icon-hourglass"></span> 已提交<span className="am-badge am-badge-secondary am-margin-right am-fr">{1}</span></a></li>
                    <li><a href="#cstm/unfinished"><span className="am-icon-archive"></span> 待完善<span className="am-badge am-badge-secondary am-margin-right am-fr">{2}</span></a></li>
