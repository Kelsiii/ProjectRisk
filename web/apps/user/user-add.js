  ...
  checkRepeat(id){
    ...
    if(this.state.repeated){
      ...
      <div className="am-cf am-padding am-padding-bottom-0">
        <div className="am-fl am-cf"><a href="/#/admin/users"><strong className="am-text-primary am-text-lg">员工</strong></a> / <small>新增账户</small></div>
      </div>
            ...
            <div className="am-form-group">
              ...
              <div className="am-u-sm-9">
                <FormGroup controlId='spec'>
									<FormControl componentClass='select' value={this.state.department} style={ {height: '40px'} }
